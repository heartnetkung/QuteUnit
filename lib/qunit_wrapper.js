...
exports.getResult = function(sourceCodeArray, mode) {
	var QUNIT_TEMPLATE =
		'<!DOCTYPE html><html><head><meta charset="utf-8"><title>mode_here</title><link rel="stylesheet" href="http://code.jquery.com/qunit/qunit-git.css"></head><body><div id="qunit"></div><div id="qunit-fixture"></div><br><br><center><h3>Test Code</h3><div id="source" style="display:inline-block;"></div></center><script src="http://code.jquery.com/qunit/qunit-git.js"></script><script>script_here ;var sourceList=source_here;var parent=document.getElementById("source");for(var i=0,ii=sourceList.length;i<ii;i++){var a=document.createElement("a");a.innerHTML=sourceList[i];a.a.href=sourceList[i];a.style.display="block";parent.appendChild(a);}</script></body></html>';
